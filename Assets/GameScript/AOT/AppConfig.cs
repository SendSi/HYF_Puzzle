public static class AppConfig
{
    ...
    public static string hostServerIP = "https://fastly.jsdelivr.net/gh/SendSi/PuzzleCDN@v1.0.2"; //cdn资源服务器  https://fastly.jsdelivr.net/gh/SendSi/PuzzleCDN@v1.0.2/CDN/WebGL
    // public static string hostServerIP = "http://127.0.0.1"; //cdn资源服务器

    public static string appVersion = "v1.0.2"; //打exe时(apk时) 的版本
    ...
    public static string resVersion = "v1.0.2"; //yooAsset生成资源时 的版本  复制时有用  editor下使用
